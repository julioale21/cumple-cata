...
export const InputFile = ({ onChangeFile }) => {
  ...
  const handleImagesChange = () => {
    ...
    onChangeFile(inputRef.current.files[0], imageURL);
  };
  ...
  return (
    <Container display="flex" my="12" flexDirection="row" justifyContent="center">
          ...
          <Box  position="relative" height="100%" width="100%">
            ...
            >
              ...
              >
                ...
                <Stack style={{ cursor: 'pointer' }} p="8" textAlign="center" spacing="1">
                  <Heading fontSize="lg" color="gray.700" fontWeight="bold">
                    Click to upload
                  </Heading>
                  <Text fontWeight="light">Comparte tu imagen</Text>
                </Stack>
              </Stack>
            </Box>
            <Input
            ...
            />
            <input onChange={handleImagesChange} ref={inputRef} style={{ display: 'none' }}  type="file" />
          </Box>
        </Box>
      </AspectRatio>
    </Container>

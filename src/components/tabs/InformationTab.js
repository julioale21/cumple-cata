    ...
    return (
        <Stack color="white" alignItems="center" justifyContent="center" width={350}>
            <Box flexDirection="column" justifyContent="flex-start" width={width}>
                <Text textAlign={["center", "left"]} fontWeight="bold" fontSize={["x-small", "xs"]}>{title}</Text>
                <Stack flexDirection="row" alignItems="center" justifyContent={["center", "flex-start"]}>
...
const Option = ({ value, selected = false }) => {
    return (
        <Box 
            ...
            width={[70,100]} 
            border={`${selected ? '1px solid black' : '2px solid white'}`} 
            padding={[1, 2]} 
            borderRadius={[20, 25]} 
  ...
  return (
    <TabPanel height="100%">
        <Stack flexDirection="column" justifyContent="center" height="100%">
            <FlightTypeList marginBottom={25} paddingLeft={[0, 50]} justifyContent={["center", "flex-start"]} />
            <Stack marginBottom={5} flexDirection={["column", "row"]} justifyContent="space-around">
                <InformationItem title="Flight to:" value="Catalina Ramirez Party" width={["100%", 250]} />
                <InformationItem title="Destination:" value="25 de Mayo Street, Number 369" width={["100%", 350]} />
            </Stack>
            <Stack marginBottom={5} flexDirection={["column", "row"]} justifyContent="space-around">
                <InformationItem title="Departure Date:" value="Saturday 22nd July 2023" width={["100%", 250]} />
                <InformationItem title="Boarding time:" value="21 HS (GMT-3)" width={["100%", 350]} />
            </Stack>
            <Stack flexDirection={["column", "row"]}>
                <InformationItem title="Passangers" value="2 Adults" width={["100%", 250]} />
            ...
            <FlightClassList marginTop={25} paddingLeft={[0, 50]} justifyContent={["center", "flex-start"]} />
        </Stack>
    </TabPanel>
  )
}

    ...
    return (
        <Stack color="white" alignItems="center" justifyContent="center" width={350}>
            <Box flexDirection="column" justifyContent="flex-start" width={width}>
                <Text fontWeight="bold" fontSize="xs">{title}</Text>
...
const Option = ({ value, selected = false }) => {
    return (
        <Box display="flex" bg={selected ? "gray.800" : "gray.600"} width={100} border={`${selected ? '1px solid black' : '2px solid white'}`} padding={2} borderRadius={25} justifyContent="center" alignItems="center">
  ...
  return (
    <TabPanel height="100%">
        <Stack flexDirection="column" justifyContent="center" height="100%">
            <FlightTypeList marginBottom={25} paddingLeft={50} />
            <Stack marginBottom={5} flexDirection="row" justifyContent="space-around">
                <InformationItem title="Flight to:" value="Catalina Ramirez Party" width={250} />
                <InformationItem title="Destination:" value="25 de Mayo Street, Number 369" width={350} />
            </Stack>
            <Stack marginBottom={5} flexDirection="row" justifyContent="space-around">
                <InformationItem title="Departure Date:" value="Saturday 22nd July 2023" width={250} />
                <InformationItem title="Boarding time:" value="21 HS (GMT-3)" width={350} />
            </Stack>
            <Stack flexDirection="row">
                <InformationItem title="Passangers" value="2 Adults" width={250} />
                <Stack flex={1} flexDirection="row" justifyContent="center">
                    <Button borderRadius={30} color="white" bg="gray.800">
                        <Text fontSize="xs">Search Flights</Text>
                    </Button >
                </Stack>
            </Stack>
            <FlightClassList marginTop={25} paddingLeft={50} />
        </Stack>
    </TabPanel>
  )
}
